...
This folder contain shared .LESS styles between all jQuery UI related themes, those files are important for all bootstrap4 themes
...
*** bootstrap3/themes/ ***
Contain all theme related to bootstrap 4
