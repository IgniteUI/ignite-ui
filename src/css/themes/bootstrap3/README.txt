...
*** bootstrap3/themes/ ***
Contain all theme that can be used with to Bootstrap 3 framework
...
themes/[Theme name]/infragistics.theme.less - The root file which import all partial files.
...
// Use this file to override all ignite UI & jQuery UI styles
@import "overrides";
==========
...
1. Go to icomoon.io/app/ and upload the file "jqurey-ui.svg" located in: css/structure/fonts
