    ...
    if (!$.ig.Editor) {
	    $.ig.Editor = {
		    locale: {
				...
				decimalUnhandledNumber: "Когато dataMode приеме стойност {0}, стойността на опцията {1} не може да надвишава {2}, тъй като операциите с такива числа могат да доведат до неочаквани резултати."
		    }
	    };
    }
})(jQuery);
